...
class Book(Base):
    ...
    # Relationships
    authors = relationship("Person", secondary=book_authors, back_populates="books")
    editors = relationship(
        "Person", secondary=book_editors, back_populates="books_edited"
    )
    translators = relationship(
        "Person", secondary=book_translators, back_populates="books_translated"
    )
    ...
    formats = relationship(
        "Format", back_populates="book", cascade="all, delete-orphan"
    )
...
class Person(Base):
    ...
    books_edited = relationship(
        "Book", secondary=book_editors, back_populates="editors"
    )
    books_translated = relationship(
        "Book", secondary=book_translators, back_populates="translators"
    )
...
class Format(Base):
    ...
    __table_args__ = (Index("idx_format_book_id", "book_id"),)
...
class Summary(Base):
    ...
    __table_args__ = (Index("idx_summary_book_id", "book_id"),)
